...
class Solution235 {
    ...
    public static void main(String[] args) {
        ...
        TreeWrapper.prettyPrintTree(new Solution235().lowestCommonAncestor(treeNode, node1, node2));
        TreeWrapper.prettyPrintTree(new Solution235().lowestCommonAncestor(treeNode, node1, node3));
    }
}