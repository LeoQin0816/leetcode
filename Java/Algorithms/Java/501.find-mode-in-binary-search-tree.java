...
class Solution501 {
    ...
    public static void main(String[] args) {
        ...
        Arrays.stream(new Solution501().findMode(treeNode)).forEach(System.out::println);

        TreeNode treeNode2 = TreeWrapper.stringToTreeNode("[1,1,2]");
        TreeWrapper.prettyPrintTree(treeNode2);
        Arrays.stream(new Solution501().findMode(treeNode2)).forEach(System.out::println);
    }
}
